	   ...
	   if (!function_exists('wpcf7')) {
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .aep-cf7 .wpcf7 input[type="text"], .aep-cf7 .wpcf7 input[type="email"], .aep-cf7 .wpcf7 textarea' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .aep-cf7 .wpcf7 input[type="text"], .aep-cf7 .wpcf7 input[type="email"], .aep-cf7 .wpcf7 textarea',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .aep-cf7 .wpcf7 input[type="text"], .aep-cf7 .wpcf7 input[type="email"], .aep-cf7 .wpcf7 textarea, .aep-cf7 .wpcf7 input[type="submit"], .aep-cf7 .wpcf7 textarea' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'=>'after'
			]
		);
		$this->add_responsive_control(
  			...
  			[
				...
				'selectors' => [
					'{{WRAPPER}} .aep-cf7 .wpcf7 input[type="text"], .aep-cf7 .wpcf7 input[type="email"], .aep-cf7 .wpcf7 textarea, .aep-cf7 .wpcf7-form' => 'width: {{SIZE}}{{UNIT}};',
				],
  			]
  		);  
		/*Textarea Height*/
        $this->add_responsive_control(
  			...
  			[
				...
				'selectors' => [
					'{{WRAPPER}} .aep-cf7 .wpcf7 input[type="text"], .aep-cf7 .wpcf7 input[type="email"]' => 'height: {{SIZE}}{{UNIT}};',
				],
  			]
  		);
